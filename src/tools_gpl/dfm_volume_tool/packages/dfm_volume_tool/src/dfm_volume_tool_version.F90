...
implicit none
    ...
    character(*),  public, parameter :: dfm_volume_tool_major        = '1'
    character(*),  public, parameter :: dfm_volume_tool_minor        = '0'
    character(*),  public, parameter :: dfm_volume_tool_revision     = '0'
    character(*),  public, parameter :: dfm_volume_tool_build_number = '000000'
