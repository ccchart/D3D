...
implicit none
    ...
    character(*),  public, parameter :: mormerge_major        = '4'
    character(*),  public, parameter :: mormerge_minor        = '00'
    character(*),  public, parameter :: mormerge_revision     = '00'
    character(*),  public, parameter :: mormerge_build_number = '000000'
    ...
    character(*),  public, parameter :: mormerge_source_code  = '@(#) : https://svn.oss.deltares.nl/repos/delft3d/trunk/src/tools_gpl/mormerge/packages/mormerge/src/mormerge_version.F90.svn $'//char(0)
