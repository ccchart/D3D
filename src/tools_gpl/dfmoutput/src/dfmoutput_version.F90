...
implicit none
    ...
    character(*),  public, parameter :: dfmoutput_major        = '1'
    character(*),  public, parameter :: dfmoutput_minor        = '0'
    character(*),  public, parameter :: dfmoutput_revision     = '0'
    character(*),  public, parameter :: dfmoutput_build_number = '000000'
