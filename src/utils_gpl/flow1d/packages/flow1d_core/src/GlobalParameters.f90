...
!-------------------------------------------------------------------------------
   ...
   logical                          :: updateTabulatedProfiles       = .true.
   ...
   integer, public, parameter :: CFiHeatConv                = 93
   integer, public, parameter :: CFiNetSolarRad             = 94
   integer, public, parameter :: CFiEffectiveBackRad        = 95
   integer, public, parameter :: CFiHeatEvap            = 96
   integer, public, parameter :: CFiHeatForcedEvap      = 97
   integer, public, parameter :: CFiHeatFreeEvap        = 98
   integer, public, parameter :: CFiHeatForcedConv          = 99
   integer, public, parameter :: CFiHeatFreeConv        = 100
