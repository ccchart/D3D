...
contains
   ...
   subroutine default_fm_statistical_output()
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_VOLTOT,                                             &
                     'Wrihis_balance', 'total_volume', '', '', 'TJ', UNC_LOC_WB, 'Write mass balance totals to his file (1: yes, 0: no)')                                                 
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_SOURCE_SINK_PRESCRIBED_DISCHARGE,                   &
                     ...
                     'm3 s-1', UNC_LOC_SOSI, 'Write sources-sinks statistics to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_GENERAL_STRUCTURE_DISCHARGE,                        &
                     ...
                     'm3 s-1', UNC_LOC_GENSTRU, 'Write general structure parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_CDAM_DISCHARGE,                                     &
                     ...
                     '', 'm3 s-1', UNC_LOC_DAM, 'Write dam parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_PUMP_STRUCTURE_DISCHARGE,                           &
                     ...
                     '', 'm3 s-1', UNC_LOC_PUMP, 'Write pump parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_GATE_DISCHARGE,                                     &
                     ...
                     '', 'm3 s-1', UNC_LOC_GATE, 'Write gate parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_WEIRGEN_DISCHARGE,                                  &
                     ...
                     '', 'm3 s-1', UNC_LOC_WEIRGEN, 'Write weir parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_ORIFICE_DISCHARGE,                                  &
                     ...
                     'm3 s-1', UNC_LOC_ORIFICE, 'Write orifice parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_BRIDGE_DISCHARGE,                                   &
                     ...
                     'm3 s-1', UNC_LOC_BRIDGE, 'Write bridge parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_CULVERT_DISCHARGE,                                  &
                     ...
                     'm3 s-1', UNC_LOC_CULVERT, 'Write culvert parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_DAMBREAK_S1UP,                                      &
                     ...
                     'm', UNC_LOC_DAMBREAK, 'Write dam break parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_UNIWEIR_DISCHARGE,                                  &
                     ...
                     'm3 s-1', UNC_LOC_UNIWEIR, 'Write universal weir parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_CMPSTRU_DISCHARGE,                                  &
                     'Wrihis_structure_cmpstru', 'cmpstru_discharge', 'Discharge through cmpstru', '',                     &
                     'm3 s-1', UNC_LOC_CMPSTRU, 'Write compound structure parameters to his file (1: yes, 0: no)')
      call addoutval(out_quan_conf_his, IDX_HIS_CMPSTRU_S1UP,                                       &
                     'Wrihis_structure_cmpstru', 'cmpstru_s1up', 'Water level upstream of cmpstru', 'sea_surface_height',   &
                     'm', UNC_LOC_CMPSTRU)
      call addoutval(out_quan_conf_his, IDX_HIS_CMPSTRU_S1DN,                                       &
                     'Wrihis_structure_cmpstru', 'cmpstru_s1dn', 'Water level downstream of cmpstru', 'sea_surface_height',   &
                     'm', UNC_LOC_CMPSTRU)
      call addoutval(out_quan_conf_his, IDX_HIS_CMPSTRU_HEAD,                                       &
                     'Wrihis_structure_cmpstru', 'cmpstru_head', 'Head difference across cmpstru', '',                     &
                     'm', UNC_LOC_CMPSTRU)
      call addoutval(out_quan_conf_his, IDX_HIS_CMPSTRU_FLOW_AREA,                                  &
                     'Wrihis_structure_cmpstru', 'cmpstru_flow_area', 'Flow area at cmpstru', '',                     &
                     'm2', UNC_LOC_CMPSTRU)
      call addoutval(out_quan_conf_his, IDX_HIS_CMPSTRU_VELOCITY,                                   &
                     'Wrihis_structure_cmpstru', 'cmpstru_velocity', 'Velocity through cmpstru', '',                     &
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_LONGCULVERT_DISCHARGE,                              &
                     ...
                     'm3 s-1', UNC_LOC_LONGCULVERT, 'Write long culvert parameters to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_TKE,                                                &
                     ...
                     'm2 s-2', UNC_LOC_STATION, 'Write k, eps and vicww to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_WINDX,                                              &
                     ...
                     'm s-1', UNC_LOC_STATION, 'Write wind velocities to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_RAIN,                                               &
                     ...
                     'mm day-1', UNC_LOC_STATION, 'Write precipitation to his file (1: yes, 0: no)')
      call addoutval(out_quan_conf_his, IDX_HIS_INFILTRATION_CAP,                                   &
                     'Wrihis_infiltration', 'infiltration_cap', 'Infiltration capacity', '',                     &
                     'mm hr-1', UNC_LOC_STATION, 'Write infiltration to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_TEMPERATURE,                                        &
                     ...
                     'degC', UNC_LOC_STATION, 'Write temperature to his file (1: yes, 0: no)')
      call addoutval(out_quan_conf_his, IDX_HIS_WIND,                                               &
                     'Wrihis_heat_fluxes', 'wind', 'windspeed', '',                     &
                     'm s-1', UNC_LOC_STATION, 'Write heat fluxes to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_SALINITY,                                           &
                     ...
                     '1e-3', UNC_LOC_STATION, 'Write salinity to his file (1: yes, 0: no)')
      call addoutval(out_quan_conf_his, IDX_HIS_POTENTIAL_DENSITY,                                  &
                     'Wrihis_density', 'potential_density', 'potential_density', '',                     &
                     'kg m-3', UNC_LOC_STATION, 'Write density to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_HWAV,                                               &
                     ...
                     'Write wave data to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_X_VELOCITY,                                         &
                     ...
                     'sea_water_x_velocity', 'm s-1', UNC_LOC_STATION, 'Write velocity vectors to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_SED,                                                &
                     ...
                     '', 'kg m-3', UNC_LOC_STATION, 'Write sediment transport to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_CONSTITUENTS,                                       &
                     ...
                     '', '-', UNC_LOC_STATION, 'Write tracers to his file (1: yes, 0: no)')
      call addoutval(out_quan_conf_his, IDX_HIS_LATERAL_PRESCRIBED_DISCHARGE_INSTANTANEOUS,         &
                     ...
                     '', 'm3 s-1', UNC_LOC_LATERAL, 'Write lateral data to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_his, IDX_HIS_VELOCITY_MAGNITUDE,                                 &
                     ...
                     'velocity magnitude',                                                                          &
                     'sea_water_speed', 'm s-1', UNC_LOC_STATION, 'Write velocity magnitude to his file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_AU,                                                 &
                     ...
                     '', 'm2', UNC_LOC_U, 'Write flow areas au to map file (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_U1,                                                 &
                     'Wrimap_velocity_component_u1', 'u1', 'Velocity at velocity point, n-component',                                                     &
                     '', 'm s-1', UNC_LOC_U, 'Write velocity component to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_U0, 'Wrimap_velocity_component_u0', &
                     ...
                     'Write velocity component for previous time step to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_UCXQ_EULERIAN,                                      &
                     ...
                     'ucxq_eulerian_velocity', 'm s-1', UNC_LOC_S, 'Write cell-center velocity vectors to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_UCMAG,                                              &
                     ...
                     'sea_water_speed', 'm s-1', UNC_LOC_S, 'Write cell-center velocity vector magnitude to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_Q1_MAIN,                                            &
                     ...
                     '', 'm3 s-1', UNC_LOC_U, 'Write flow flux in main channel to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_FIXED_WEIR_ENERGY_LOSS,                             &
                     ...
                     '', 'm', UNC_LOC_U, 'Write fixed weir energy loss to map file (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_SPIRCRV,                                            &
                     'Wrimap_spiral_flow', 'spircrv', 'Flow streamline curvature',                                                     &
                     'streamline_curvature', '1/m', UNC_LOC_S, 'Write spiral flow to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_NUMLIMDT,                                           &
                     ...
                     '', '1', UNC_LOC_S, 'Write the number times a cell was Courant limiting to map file (1: yes, 0: no). (Consider using Wrimap_flow_analysis instead.)')
      call addoutval(out_quan_conf_map, IDX_MAP_TAUSX,                                              &
                     'Wrimap_taucurrent', 'tausx', 'Total bed shear stress vector, x-component',                                    &
                     '', 'N m-2', UNC_LOC_S, 'Write the shear stress to map file (1: yes, 0: no)') 
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_TEM1,                                               &
                     ...
                     'sea_water_temperature', 'degC', UNC_LOC_S, 'Write constituents to map file (1: yes, 0: no)') 
      call addoutval(out_quan_conf_map, IDX_MAP_CONST,                                              &
                     'Wrimap_sediment', 'const', '',                                                                              &
                     '', '-', UNC_LOC_S, 'Write sediment fractions to map file (1: yes, 0: no)') 
      call addoutval(out_quan_conf_map, IDX_MAP_MORS,                                               &
                     'Wrimap_turbulence', 'mors', '',                                                                              &
                     '', '-', UNC_LOC_S, 'Write vicww, k and eps to map file (1: yes, 0: no)') 
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_CFRT_1,                                             &
                     ...
                     '', '', UNC_LOC_L, 'Write trachytope roughnesses to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_CFCL,                                               &
                     ...
                     '', '-', UNC_LOC_L, 'Write roughness calibration factors to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_RAINFALL_RATE,                       &
                     ...
                     'rainfall_rate', 'm s-1', UNC_LOC_S, 'Write rainfall rates to map file (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_INTERCEPTION_WATERDEPTH,             &
                     ...
                     '', 'm', UNC_LOC_S, 'Write interception to map file (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_PATM,                                &
                     'Wrimap_wind', 'Patm', 'Atmospheric pressure near surface',                                        &
                     'surface_air_pressure', 'N m-2', UNC_LOC_S, 'Write wind velocities to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_WINDSTRESSX,                         &
                     ...
                     'surface_downward_x_stress', 'N m-2', UNC_LOC_S)
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_TAIR ,                               &
                     ...
                     'Air temperature near surface', 'degC', UNC_LOC_S, 'Write heat fluxes to map file (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_DTCELL,                              &
                     ...
                     '', 's', UNC_LOC_S, 'Write time step per cell based on CFL (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_TIME_WATER_ON_GROUND,                &
                     ...
                     '', 's', UNC_LOC_S, 'Write cumulative time when water is above ground level to map file, only for 1D nodes (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_FREEBOARD,                           &
                     'Wrimap_freeboard', 'freeboard', 'Freeboard',                                                                &
                     '', 'm', UNC_LOC_S, 'Write freeboard to map file, only for 1D nodes (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_WATERDEPTH_ON_GROUND,                &
                     ...
                     '', 'm', UNC_LOC_S, 'Write waterdepth that is above ground level to map file, only for 1D nodes (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_VOLUME_ON_GROUND,                    &
                     ...
                     '', 'm3', UNC_LOC_S, 'Write volume that is above ground level to map file, only for 1D nodes (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_CURRENT_TOTAL_NET_INFLOW_1D2D,       &
                     ...
                     '', 'm3 s-1', UNC_LOC_S, 'Write current total 1d2d net inflow (discharge) and cumulative total 1d2d net inflow (volume) to map file, only for 1D nodes (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_CURRENT_TOTAL_NET_INFLOW_LATERAL,    &
                     ...
                     '', 'm3 s-1', UNC_LOC_S, 'Write current total lateral net inflow (discharge) and cumulative total net lateral inflow (volume) to map file, only for 1D nodes (1: yes, 0: no)')
      ...
      call addoutval(out_quan_conf_map, IDX_MAP_WATER_LEVEL_GRADIENT,                &
                     ...
                     '', '1', UNC_LOC_U, 'Write water level gradient to map file, only on 1D links (1: yes, 0: no)')
      call addoutval(out_quan_conf_map, IDX_MAP_QIN,                                 &
                     'Wrimap_Qin', 'qin', 'Sum of all water influx',                                                  &
                     '', 'm3 s-1', UNC_LOC_S, 'Write sum of all influxes to map file (1: yes, 0: no)')
