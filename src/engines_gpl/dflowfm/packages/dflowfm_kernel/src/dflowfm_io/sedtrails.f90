module m_sedtrails
   ...
   ! JRE Clean this after throwing out all 1D stuff
       ...
       bamin    = 1d-6     ! minimum 2D cell area
   ...
   subroutine sedtrails_setnodadm(jacrosscheck_)
   use m_sedtrails_data
   ...
   call sedtrails_setnodadm_grd_op(10+jacrosscheck_)

end subroutine sedtrails_setnodadm
   
SUBROUTINE sedtrails_SETNODADM_GRD_OP(JACROSSCHECK_)
   ...
   double precision              :: phi,  dmaxcosp, dcosp, costriangleminangle, phi0
...
!   subroutine sedtrails_geominit(iphase)                          ! initialise sedtrails geometry
!     
!     implicit none
!     
...
! endif
!
! end subroutine sedtrails_geominit
