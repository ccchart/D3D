...
logical, dimension (:), allocatable            :: calculate_for
integer, dimension (:), allocatable            :: list_of_upwind_cells, number_of_upwind_cells
double precision, dimension (:,:), allocatable :: data_at_upwind_cells
double precision, dimension (:,:), allocatable :: fetch_temp
