...
call update_statistical_output(out_variable_set_his%statout)
call update_statistical_output(out_variable_set_map%statout)
call update_statistical_output(out_variable_set_classmap%statout)
