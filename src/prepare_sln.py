...
def build_gui():
    ...
    Radiobutton(root, text="VS 2022                           ", variable=vs_gui, value=2022).grid(row= 6, column=0, sticky=W)
    Radiobutton(root, text="VS 2019                           ", variable=vs_gui, value=2019).grid(row= 7, column=0, sticky=W)
    Radiobutton(root, text="VS 2017                           ", variable=vs_gui, value=2017).grid(row= 8, column=0, sticky=W)
    Radiobutton(root, text="VS 2015, Update 3                 ", variable=vs_gui, value=2015).grid(row= 9, column=0, sticky=W)
    # default value
    vs_gui.set(2017)
    ...
    if chooseIfort == 1:
        ...
        Radiobutton(root, text="IFORT22: Intel oneAPI HPC 2022                 ", variable=ifort_gui, value=22).grid(row= 6, column=2, sticky=W)
        Radiobutton(root, text="IFORT21: Intel oneAPI HPC 2021                 ", variable=ifort_gui, value=21).grid(row= 7, column=2, sticky=W)
        Radiobutton(root, text="IFORT19: Intel Parallel Studio XE 2019         ", variable=ifort_gui, value=19).grid(row= 8, column=2, sticky=W)
        Radiobutton(root, text="IFORT18: Intel Parallel Studio XE 2018 Update 4", variable=ifort_gui, value=18).grid(row= 9, column=2, sticky=W)
        Radiobutton(root, text="IFORT17: (Not Recommended)                     ", variable=ifort_gui, value=17).grid(row=10, column=2, sticky=W)
        Radiobutton(root, text="IFORT16: Intel Parallel Studio XE 2016 Update 4", variable=ifort_gui, value=16).grid(row=11, column=2, sticky=W)
        # default value
        ifort_gui.set(18)
    else:
        ifort_gui.set(-999)
